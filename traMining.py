...
def lost_VIN(tra_previous, tra_current):
	...
	This function is to record the VIN numbers of these cars.
...
def mat_generation(tra):
	...
	:param tra: A trajectory pd.DataFrame,
	containing a column named 'VIN', which is the identification number of a car,
...
def mapDict2matVector(map_dict):
	...
	:param map_dict: A dictionary generated by function mat_generation.
